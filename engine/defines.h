...
#define FSN_PLATFORM_WINDOWS 1
#ifndef _WIN64
#error "64-bit is required on Windows!"
#endif
#elif defined(__linux__) || defined(__gnu_linux__)
//Linux OS
#define FSN_PLATFORM_LINUX 1
#if defined(__ANDROID__)
#define FSN_PLATFORM_ANDROID 1
#endif
#elif defined(__unix__)
//Catch anything not caught by the above.
#define FSN_PLATFORM_UNIX 1
#elif defined(_POSIX_VERSION)
//Posix
#define FSN_PLATFORM_POSIX 1
#elif __APPLE__
//Apple platforms
#define FSN_PLATFORM_APPLE 1
#include <TargetConditionals.h>
#if TARGET_IPHONE_SIMULATOR
//iOS Simulator
#define FSN_PLATFORM_IOS 1
#define FSN_PLATFORM_IOS_SIMULATOR 1
...
// Inlining
#ifdef _MSC_VER
#define FSN_INLINE __forceinline
#define FSN_NOINLINE __declspec(noinline)
#else
#define FSN_INLINE static inline
#define FSN_NOINLINE
#endif
