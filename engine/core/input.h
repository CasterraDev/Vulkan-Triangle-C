...
// keyboard input
CT_API b8 inputIsKeyDown(keys key);
CT_API b8 inputIsKeyUp(keys key);
CT_API b8 inputWasKeyDown(keys key);
CT_API b8 inputWasKeyUp(keys key);
CT_API b8 inputIsKeyReleased(keys key);
CT_API b8 inputIsKeyPressed(keys key);

void inputProcessKey(keys key, b8 pressed);

// mouse input
CT_API b8 inputIsButtonDown(buttons button);
CT_API b8 inputIsButtonPressed(buttons button);
CT_API b8 inputIsButtonReleased(buttons button);
CT_API b8 inputIsButtonUp(buttons button);
CT_API b8 inputWasButtonDown(buttons button);
CT_API b8 inputWasButtonUp(buttons button);
CT_API void inputGetMousePosition(i32* x, i32* y);
CT_API void inputGetPreviousMousePosition(i32* x, i32* y);
